...
const displayContent = (text, id) => {
  return text.length < 30
    ? text
    : text.slice(0, 30) +
        `<span class='fw-bold' style='cursor: pointer;' onclick="displayFullContent('${text}', ${id})">... read more</span>`;
};

const displayFullContent = (value, id) => {
  document.getElementById(`display-contant-${id}`).innerHTML = value;
};
